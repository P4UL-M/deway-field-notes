...
: "${UMAMI_ADMIN_PASSWORD:?Missing UMAMI_ADMIN_PASSWORD}"
: "${UMAMI_CURRENT_ADMIN_PASSWORD:?Missing UMAMI_CURRENT_ADMIN_PASSWORD}"
...
auth="$(login "$UMAMI_CURRENT_ADMIN_PASSWORD")"
...
echo "✓ Analytics ready on the private server endpoint"
